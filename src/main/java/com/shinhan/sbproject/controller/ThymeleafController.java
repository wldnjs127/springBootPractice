...
public class ThymeleafController {
	...
	@GetMapping("/hello3")
	public void f3(Model model, HttpServletRequest request, HttpSession session) {
	...
	public void f3(Model model) {
		...
		brepo.findById(20L).ifPresent(b->{
			log.info(b.toString());
		});
	}
	...
	public String f2(Model model) {
		model.addAttribute("greetings","안녕.");
	...
	public void f1(Model model) {
		log.info("hello 요청");
		model.addAttribute("greetings","감사합니다.");
